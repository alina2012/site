...
<body class="adaptive">
 ...
 <div class="checkout-v1-wrapper">
   ...
   <form action="\myshop.ru\send.php" accept-charset="UTF-8" method="post">
   	<input name="utf8" type="hidden" value="&#x2713;" />
   	<div class="field fc">
        <div class="field-label"><b>Введите e-mail</b></div>
        <div class="field-content"><input type="text" name="email" id="email" class="textfield" /></div>
      </div>
      <div class="field fc">
