...
<body class="adaptive">
 ...
 <div class="checkout-v1-wrapper">
   ...
   <form action="\myshop.ru\update_pas.php" accept-charset="UTF-8" method="post">
   	<input name="utf8" type="hidden" value="&#x2713;" />
   	<div class="field fc">
        <div class="field-label"><b>Введите новый пароль</b></div>
        <div class="field-content"><input type="password" name="password" id="password" class="textfield" /></div>
      </div>
      <div class="field fc">
        <div class="field-label"><b>Подтвердите пароль</b></div>
        <div class="field-content"><input type="password" name="conf_pass" id="conf_pass" class="textfield" /></div>
      </div>
      <div class="field fc">
